...
namespace ColorPickerWPF.Code
{
    internal static class Util
    {
        ...
        public static Color FromAhsv(int alpha, double hue, double saturation, double valus)
        {
            ...
            if (0f > valus || 1f < valus)
            {
                throw new ArgumentOutOfRangeException("brightness", valus,
                  "Value must be within a range of 0 - 1.");
            }
            ...
            if (0.5 < valus)
            {
                fMax = valus - (valus * saturation) + saturation;
                fMin = valus + (valus * saturation) - saturation;
            }
            else
            {
                fMax = valus + (valus * saturation);
                fMin = valus - (valus * saturation);
            }
