...
namespace ColorPickerWPF
{
    ...
    public partial class ColorPickerWindow : Window
    {
        ...
        public static bool ShowDialog(out Color color, Color initialColor, ColorPickerDialogOptions flags = ColorPickerDialogOptions.None, ColorPickerControl.ColorPickerChangeHandler customPreviewEventHandler = null)
        {
            ...
            instance.ColorPicker.SetColorRGB(initialColor);
            instance.ColorPicker.SetColorHSV(initialColor);
