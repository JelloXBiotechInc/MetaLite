...
namespace OpenSlideNET.Interop
{
    public static partial class OpenSlideInterop
    {
        ...
        [DllImport(LibOIR, EntryPoint = "Java_jp_co_olympus_hpf_data_format_raw_idaloader_OIRLoader_open", CallingConvention = CallingConvention.Cdecl)]
        private static extern void test(int sdpaok);
        ...
        public static void tttt(int osr)
            => test(osr);
