...
namespace MetaLite_Viewer.SubUnit
{
    public class SimpleCircleAdorner : Adorner
    {
            ...
            : base(adornedElement)
        {
            ...
            {
                Width = adornedElement.RenderSize.Width - 2,
                Height = adornedElement.RenderSize.Height + 4
            };


            var animation = new DoubleAnimation(1, 1, new Duration(TimeSpan.FromSeconds(1)))
            {
                AutoReverse = true,
